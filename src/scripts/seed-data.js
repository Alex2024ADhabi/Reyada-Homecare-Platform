...
async function seedDatabase() {
    try {
        ...
        if (count > 0) {
            console.log(`Database already has ${count} referrals. Skipping seed operation.`);
            return;
        }
        ...
        const referrals = [
            {
                ...
                statusNotes: "Initial assessment scheduled, awaiting insurance approval",
            ...
            },
            {
                ...
                statusNotes: "Patient decided to use hospital outpatient services instead",
        ...
        console.log(`${result.insertedCount} referrals successfully seeded to database`);
    }
    catch (error) {

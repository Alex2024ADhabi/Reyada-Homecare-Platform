...
export const useSecureMessaging = (patientId) => {
            ...
            const mockConversations = [
                {
                    ...
                    lastMessage: {
                        ...
                        subject: "Medication Questions",
                        content: "Please remember to take your evening medication and record your blood sugar levels.",
                        priority: "normal",
                        status: "delivered",
                ...
                },
                {
                    ...
                    lastMessage: {
                        ...
                        subject: "Appointment Confirmation",
                        content: "Thank you for confirming my appointment. I'll be ready at 10 AM.",
                        priority: "normal",
                        status: "read",
            ...
            const mockMessages = [
                {
                    ...
                    recipientType: "patient",
                    subject: "Medication Questions",
                    content: "Hello Ahmed, I hope you're doing well. I wanted to check in about your medication routine.",
                    priority: "normal",
                    status: "read",
                ...
                },
                {
                    ...
                    recipientType: "provider",
                    subject: "Medication Questions",
                    content: "Hi Dr. Johnson, I've been taking my medication as prescribed. I have a question about the timing though.",
                    priority: "normal",
                    status: "read",
                ...
                },
                {
                    ...
                    recipientType: "patient",
                    subject: "Medication Questions",
                    content: "Please remember to take your evening medication and record your blood sugar levels. Let me know if you have any concerns.",
                    priority: "normal",
                    status: "delivered",
                    sentAt: "2024-01-18T18:00:00Z",
                },
    ...
    const sendMessage = async (messageData) => {
        try {
            ...
            setConversations((prev) => prev.map((conv) => conv.id === messageData.conversationId
    ...
    const archiveConversation = async (conversationId) => {
        try {
            ...
            // Update local state
            setConversations((prev) => prev.map((conv) => conv.id === conversationId ? { ...conv, status: "archived" } : conv));
        }
        catch (err) {

...
export const useEducationalResources = (patientId) => {
            ...
            const mockResources = [
                {
                    ...
                    description: "Learn about the best foods for diabetes management and how to create a balanced meal plan.",
                ...
                },
                {
                    ...
                    description: "Step-by-step video guide on how to properly monitor your blood sugar levels at home.",
                ...
                },
                {
                    ...
                    description: "Visual guide to help you remember when to take your medications throughout the day.",
                    ...
                    thumbnailUrl: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&q=80",
                ...
                },
                {
                    ...
                    description: "Interactive tool to help you create a personalized exercise plan based on your health conditions.",
                ...
                },
                {
                    ...
                    description: "Downloadable emergency action plan template for diabetes-related emergencies.",
                    ...
                    language: "en",
                    personalizedFor: ["diabetes"],
                    thumbnailUrl: "https://images.unsplash.com/photo-1584467735871-8e4b8c0b1b8c?w=400&q=80",
    ...
    const fetchBookmarkedResources = async () => {
        try {
            // TODO: Replace with actual API call
            const response = await fetch(`/api/patient/${patientId}/bookmarked-resources`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("patient_token")}`,
                },
            });
    ...
    const fetchRecentlyViewed = async () => {
        try {
            // TODO: Replace with actual API call
            const response = await fetch(`/api/patient/${patientId}/recently-viewed-resources`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("patient_token")}`,
                },
            });
    ...
    const searchResources = async (query, filters) => {
        try {
            ...
            // TODO: Replace with actual API call
            const response = await fetch(`/api/educational-resources/search?${params}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("patient_token")}`,
                },
            });
    ...
    const markAsViewed = async (resourceId) => {
        try {
            // TODO: Replace with actual API call

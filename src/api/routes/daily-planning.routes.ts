...
router.post("/integrate-patient-priorities", async (req, res) => {
  try {
    ...
    const classifications =
      await integratePatientPriorityClassification(patient_ids);
...
router.post("/optimize-resources", async (req, res) => {
  try {
    const { staff_assigned, patient_priorities, equipment_availability } =
      req.body;

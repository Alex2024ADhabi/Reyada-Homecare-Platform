...
import { getQualityManagementRecords, getQualityManagementById, createQualityManagementRecord, updateQualityManagementRecord, getJAWDAKPIRecords, createJAWDAKPIRecord, automateKPIDataCollection, getComplianceMonitoringRecords, createComplianceMonitoringRecord, getAuditManagementRecords, createAuditManagementRecord, getQualityAnalytics, getComplianceDashboardData, performAutomatedComplianceCheck, prepareDOHAudit, getRealTimeComplianceScore, } from "../quality-management.api";
...
router.post("/compliance/automated-check", async (req, res) => {
    try {
        ...
        const complianceResult = await performAutomatedComplianceCheck(regulation_type);

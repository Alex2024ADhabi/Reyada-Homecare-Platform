...
export class ErrorHandlerService {
  ...
  public setToastContext(context: any) {
  ...
  public handleValidationErrors(errors: ValidationError[]): void {
  ...
  public handleOfflineError(operation: string): void {

...
import { AWS_REGIONS } from "./aws.config";

// Redis Cluster Configuration
export const REDIS_CLUSTER_CONFIG = {
  primary: {
    host:
      process.env.REDIS_CLUSTER_PRIMARY_HOST ||
  ...
  secondary: {
    host:
      process.env.REDIS_CLUSTER_SECONDARY_HOST ||
...
export const IGNITE_CONFIG = {
  ...
  persistence: {
    ...
    walArchivePath:
      process.env.IGNITE_WAL_ARCHIVE_PATH || "/opt/ignite/wal-archive",
    walMode: "LOG_ONLY",
